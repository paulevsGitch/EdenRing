...
public class EdenRecipes {
	...
	public static void init() {
		BCLRecipeBuilder.crafting(EdenRing.makeID("gravilite_block"), EdenBlocks.GRAVILITE_BLOCK).checkConfig(CONFIG).setShape("##", "##").addMaterial('#', EdenBlocks.GRAVILITE_SHARDS).build();
		BCLRecipeBuilder.crafting(EdenRing.makeID("gravilite_shards"), EdenBlocks.GRAVILITE_SHARDS).checkConfig(CONFIG).setList("#").addMaterial('#', EdenBlocks.GRAVILITE_BLOCK).setOutputCount(4).build();
		BCLRecipeBuilder.crafting(EdenRing.makeID("gravilite_lamp"), EdenBlocks.GRAVILITE_LAMP).checkConfig(CONFIG).setShape(" I ", "I#I", " I ").addMaterial('#', EdenBlocks.GRAVILITE_BLOCK).addMaterial('I', CommonItemTags.IRON_INGOTS).build();
		BCLRecipeBuilder.crafting(EdenRing.makeID("gravilite_lantern_tall"), EdenBlocks.GRAVILITE_LANTERN_TALL).checkConfig(CONFIG).setShape("I", "#", "I").addMaterial('#', EdenBlocks.GRAVILITE_SHARDS).addMaterial('I', CommonItemTags.IRON_INGOTS).build();
		BCLRecipeBuilder.crafting(EdenRing.makeID("gravilite_lantern"), EdenBlocks.GRAVILITE_LANTERN).checkConfig(CONFIG).setShape(" I ", "I#I", " I ").setOutputCount(2).addMaterial('#', EdenBlocks.GRAVILITE_SHARDS).addMaterial('I', CommonItemTags.IRON_INGOTS).build();
		...
		BCLRecipeBuilder.crafting(EdenRing.makeID("yellow_dye"), Items.YELLOW_DYE).checkConfig(CONFIG).setList("#").addMaterial('#', EdenBlocks.GOLDEN_GRASS).build();
		BCLRecipeBuilder.crafting(EdenRing.makeID("magenta_dye"), Items.MAGENTA_DYE).checkConfig(CONFIG).setList("#").addMaterial('#', EdenBlocks.VIOLUM).build();
		...
		BCLRecipeBuilder.smelting(EdenRing.makeID("slime_ball"), Items.SLIME_BALL).setInput(EdenBlocks.VOLVOX_BLOCK).checkConfig(CONFIG).build();
		BCLRecipeBuilder.smelting(EdenRing.makeID("slime_ball_4"), Items.SLIME_BALL).setInput(EdenBlocks.VOLVOX_BLOCK_DENSE).setOutputCount(4).checkConfig(CONFIG).build();
		BCLRecipeBuilder.smelting(EdenRing.makeID("limphium_leaf"), EdenItems.LIMPHIUM_LEAF_DRYED).setInput(EdenItems.LIMPHIUM_LEAF).checkConfig(CONFIG).build();
