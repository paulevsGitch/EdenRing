...
public class EdenFeatures {
	...
	public static final BCLFeature ROUND_CAVE = BCLCommonFeatures.makeChancedFeature(EdenRing.makeID("round_cave"), Decoration.RAW_GENERATION, new RoundCaveFeature(), 2);
